...
HD_PWD='C:/FPGA/lect8_1/tinyprocessor/tinyprocessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topmodule_fourbit_tiny_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topmodule_fourbit_tiny_processor.tcl
