...
HD_PWD='C:/FPGA/lect8_1/tinyprocessor/tinyprocessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topmodule_fourbit_tiny_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topmodule_fourbit_tiny_processor.tcl -notrace
